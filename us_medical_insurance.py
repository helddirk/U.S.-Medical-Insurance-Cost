...
# I will first investigate the charges for the age groups and the BMI.
...
# There are 662 female in the dataset with an average cost of 12569.58 Dollar.
...
# There are 676 male in the dataset with an average cost of 13956.75 Dollar.
...
# average cost for differnent amount of children
...
# with an average cost of 32050.23 Dollar.
...
# with an average cost of 8434.27 Dollar.
...
# In this bmi group are 81% non-smokers and 19% smoker.
print("\nThere are " + str(ns_bmi_5[0]) + " non-smoker with extreme obesity." +
      "\nThey have an average cost of " + str(ns_bmi_5[1]) + " Dollar.")
print("There are " + str(s_bmi_5[0]) + " smoker with extreme obesity." +
...
# There are 245 non-smoker with extreme obesity.
# They have an average cost of 9244.5 Dollar.
# There are 71 smoker with extreme obesity.
# They have an average cost of 43556.4 Dollar.
# In this bmi group are 78% non-smokers and 22% smoker.

# The fourth most influence on the costs had the amount of children.
# I will do the same with the amount of children as I did for the age and BMI.
# I do this only for the amount of children from 0-3. Because before the data
# for people with more children was already not enough.

ns_children_0 = group_costs_num(0, 1, ns_children, ns_charges)
s_children_0 = group_costs_num(0, 1, s_children, s_charges)
ns_children_1 = group_costs_num(1, 2, ns_children, ns_charges)
s_children_1 = group_costs_num(1, 2, s_children, s_charges)
ns_children_2 = group_costs_num(2, 3, ns_children, ns_charges)
s_children_2 = group_costs_num(2, 3, s_children, s_charges)
ns_children_3 = group_costs_num(3, 4, ns_children, ns_charges)
s_children_3 = group_costs_num(3, 4, s_children, s_charges)

print("")
print("\nThere are " + str(ns_children_0[0]) +
      " non-smokers with 0 children. They have an average cost of " +
      str(ns_children_0[1]) + " Dollar.")
print("There are " + str(s_children_0[0]) +
      " smokers with 0 children. They have an average cost of " +
      str(s_children_0[1]) + " Dollar.")
print("In this group are "+
      str(round(ns_children_0[0]/(ns_children_0[0]+s_children_0[0])*100)) +
      "% non-smokers and " + 
      str(round(s_children_0[0]/(ns_children_0[0]+s_children_0[0])*100)) +
      "% smoker.")
# There are 459 non-smokers with 0 children.
# They have an average cost of 7611.79 Dollar.
# There are 115 smokers with 0 children.
# They have an average cost of 31341.36 Dollar.
# In this group are 80% non-smokers and 20% smoker.
print("\nThere are " + str(ns_children_1[0]) +
      " non-smokers with 1 child. They have an average cost of " +
      str(ns_children_1[1]) + " Dollar.")
print("There are " + str(s_children_1[0]) +
      " smokers with 1 child. They have an average cost of " +
      str(s_children_1[1]) + " Dollar.")
print("In this group are "+
      str(round(ns_children_1[0]/(ns_children_1[0]+s_children_1[0])*100)) +
      "% non-smokers and " +
      str(round(s_children_1[0]/(ns_children_1[0]+s_children_1[0])*100)) +
      "% smoker.")
# There are 263 non-smokers with 1 child.
# They have an average cost of 8303.11 Dollar.
# There are 61 smokers with 1 child.
# They have an average cost of 31822.65 Dollar.
# In this group are 81% non-smokers and 19% smoker.
print("\nThere are " + str(ns_children_2[0]) +
      " non-smokers with 2 children. They have an average cost of " +
      str(ns_children_2[1]) + " Dollar.")
print("There are " + str(s_children_2[0]) +
      " smokers with 2 children. They have an average cost of " +
      str(s_children_2[1]) + " Dollar.")
print("In this group are "+
      str(round(ns_children_2[0]/(ns_children_2[0]+s_children_2[0])*100)) +
      "% non-smokers and " +
      str(round(s_children_2[0]/(ns_children_2[0]+s_children_2[0])*100)) +
      "% smoker.")
# There are 185 non-smokers with 2 children.
# They have an average cost of 9493.09 Dollar.
# There are 55 smokers with 2 children.
# They have an average cost of 33844.24 Dollar.
# In this group are 77% non-smokers and 23% smoker.
print("\nThere are " + str(ns_children_3[0]) +
      " non-smokers with 3 children. They have an average cost of " +
      str(ns_children_3[1]) + " Dollar.")
print("There are " + str(s_children_3[0]) +
      " smokers with 3 children. They have an average cost of " +
      str(s_children_3[1]) + " Dollar.")
print("In this group are "+
      str(round(ns_children_3[0]/(ns_children_3[0]+s_children_3[0])*100)) +
      "% non-smokers and " +
      str(round(s_children_3[0]/(ns_children_3[0]+s_children_3[0])*100)) +
      "% smoker.")
# There are 118 non-smokers with 3 children.
# They have an average cost of 9614.52 Dollar.
# There are 39 smokers with 3 children.
# They have an average cost of 32724.92 Dollar.
# In this group are 75% non-smokers and 25% smoker.
